...
try:
    ...
    try:
        ...
        config_settings.set("色花堂", "色花堂网址", "https://www.sdfasf.space/")  # 用于另一个项目的，这里请无视
                    ...
                    if if_jpg == '是':
                        ...
                        try:
                            ...
                            try:
                                ...
                                fail_times += 1
                                fail_message = '    >第' + str(
                                    fail_times) + '个失败！连接javbus失败：' + bus_search_url + '，\\' + root.lstrip(
                                    path) + '\\' + file + '\n'
                                print(fail_message, end='')
                                fail_list.append(fail_message)
                                write_fail(fail_message)
                            ...
                            if str(coverg) != 'None':
                                ...
                                fail_times += 1
                                fail_message = '    >第' + str(
                                    fail_times) + '个失败！查找封面失败：' + bus_search_url + '，\\' + root.lstrip(
                                    path) + '\\' + file + '\n'
                                print(fail_message, end='')
                                fail_list.append(fail_message)
                                write_fail(fail_message)
                        ...
                        try:
                            ...
                            fail_times += 1
                            fail_message = '    >第' + str(fail_times) + '个失败！poster裁剪失败，请手动裁剪它吧：\\' + root.lstrip(path) + '\\' + file + '\n'
                            print(fail_message, end='')
                            fail_list.append(fail_message)
                            write_fail(fail_message)
                            continue
